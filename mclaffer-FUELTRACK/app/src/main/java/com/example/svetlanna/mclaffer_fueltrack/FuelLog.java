...
public class FuelLog extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE = "com.example.svetlanna.mclaffer_fueltrack.MESSAGE";

    /** Called when the user clicks the Create Log Entry button */
    public void createLogEntry(View view) {
        // Do something in response to button
        Intent intent = new Intent(this, FuelLogEntry.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_log_entry_view, menu);
        return true;
    }
